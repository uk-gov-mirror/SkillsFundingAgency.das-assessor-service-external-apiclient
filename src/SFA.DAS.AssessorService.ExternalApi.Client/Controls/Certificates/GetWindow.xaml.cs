namespace SFA.DAS.AssessorService.ExternalApi.Client.Controls.Certificates
{
    ...
    {
        private ViewModels.Certificates.GetViewModel _ViewModel => DataContext as ViewModels.Certificates.GetViewModel;
        ...
        private void btnOpen_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (openFileDialog.ShowDialog() == true)
            {
                ...
                var items = CsvFileHelper<GetCertificateRequest>.GetFromFile<GetCertificateRequest>(_ViewModel.FilePath);
        ...
        private async Task GetCertificates()
        {
            ...
            using (HttpClient httpClient = new HttpClient())
            {
                ...
                try
                {
                    ...
                    foreach (var certificate in _ViewModel.Requests)
                    {
