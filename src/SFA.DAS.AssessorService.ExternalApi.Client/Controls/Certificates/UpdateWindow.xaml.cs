namespace SFA.DAS.AssessorService.ExternalApi.Client.Controls.Certificates
{
    ...
    {
        private ViewModels.Certificates.UpdateViewModel _ViewModel => DataContext as ViewModels.Certificates.UpdateViewModel;
        ...
        private void btnOpen_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (openFileDialog.ShowDialog() == true)
            {
                ...
                var items = CsvFileHelper<UpdateCertificateRequest>.GetFromFile<UpdateCertificateRequest>(_ViewModel.FilePath);
        ...
        private async Task UpdateCertificates()
        {
            ...
            using (HttpClient httpClient = new HttpClient())
            {
                ...
                IEnumerable<UpdateCertificateResponse> results;

                try
                {
                    BusyIndicator.IsBusy = true;
                    results = await certificateApiClient.UpdateCertificates(_ViewModel.Requests);
                }
                finally
                {
        ...
        private void SaveInvalidCertificates(IEnumerable<UpdateCertificateResponse> invalidCertificates)
        {
